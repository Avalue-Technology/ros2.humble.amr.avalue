...
def generate_launch_description():
    ...
    avalue_robot = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(bringup_dir, 'launch','turn_on_avalue_robot.launch.py')),
    )
    avalue_lidar = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(bringup_dir, 'launch', 'avalue_lidar.launch.py')),
    )
    ...
    parameters={
          'frame_id':'camera_link', #avalue:camera_link
    ...
    return LaunchDescription([
        avalue_robot,avalue_lidar,avalue_camera,
