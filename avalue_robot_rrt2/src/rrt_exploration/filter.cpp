...
#include "avalue_rrt_msg/msg/point_array.hpp"
...
class Filter : public rclcpp::Node
{
  public:
	...
	: Node("filter")
	{
		...
		filtered_goal_points_publisher = this->create_publisher<avalue_rrt_msg::msg::PointArray>(filtered_goal_points_publisher_topic,10);
  ...
  private:
	...
	void timer_callback(){
		...
		avalue_rrt_msg::msg::PointArray filtered_goal_points;
	...
	rclcpp::Publisher<avalue_rrt_msg::msg::PointArray>::SharedPtr filtered_goal_points_publisher;
