...
#ifndef __avalue_ROBOT_H_
#define __avalue_ROBOT_H_
...
#include "avalue_robot_msg/msg/supersonic.hpp"
...
class turn_on_robot : public rclcpp::Node
{
	...
	private:
		...
		rclcpp::Publisher<avalue_robot_msg::msg::Supersonic>::SharedPtr distance_publisher;         
