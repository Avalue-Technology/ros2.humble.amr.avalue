...
def generate_launch_description():
    ...
    ekf_config = Path(get_package_share_directory('turn_on_avalue_robot'), 'config', 'ekf.yaml')
    ekf_carto_config = Path(get_package_share_directory('turn_on_avalue_robot'), 'config', 'ekf_carto.yaml')

    imu_config = Path(get_package_share_directory('turn_on_avalue_robot'), 'config', 'imu.yaml')
    ...
    avalue_robot = IncludeLaunchDescription(
            ...
            launch_arguments={'use_avalue_imu':'true'}.items(),
    )
     
     
    robot_ekf = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'avalue_ekf.launch.py')),
