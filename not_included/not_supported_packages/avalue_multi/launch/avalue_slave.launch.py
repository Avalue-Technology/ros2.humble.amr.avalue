...
def generate_launch_description():
  base_dir = get_package_share_directory('turn_on_avalue_robot')
  base_launch_dir = os.path.join(base_dir,'launch')
  multi_dir = get_package_share_directory('avalue_multi')
  multi_launch_dir = os.path.join(multi_dir,'launch')
  nav2_dir = get_package_share_directory('avalue_nav2')
  nav2_bringup_dir = get_package_share_directory('nav2_bringup')
  nav2_launch_dir = os.path.join(nav2_bringup_dir,'launch')
  my_map_dir = os.path.join(nav2_dir, 'map')
  my_param_dir = os.path.join(nav2_dir, 'param','avalue_params')
...
#**参数设置*********************************************************************>>
  ...
  map_yaml_file = DeclareLaunchArgument('map_yaml_file', default_value=os.path.join(my_map_dir, 'avalue.yaml'))
...
#<<**定位*********************************************************************
  ...
  avalue_robot = IncludeLaunchDescription(
  	PythonLaunchDescriptionSource(os.path.join(base_launch_dir,"turn_on_avalue_robot.launch.py")))
  #开启雷达
  avalue_lidar = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(base_launch_dir, 'avalue_lidar.launch.py')))
