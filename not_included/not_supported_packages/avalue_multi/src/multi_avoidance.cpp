...
返回  值：无
**************************************************************************/
void current_position_Callback(const avalue_robot_msg::msg::Position& msg)	
{
...
int main(int argc, char** argv)
{
	...
	auto current_position_sub = nh->create_subscription<avalue_robot_msg::msg::Position>("object_tracker/current_position", 5,current_position_Callback);
