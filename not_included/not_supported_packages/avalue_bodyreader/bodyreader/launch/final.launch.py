...
def generate_launch_description():
    # 获取包的 share 目录
    turn_on_avalue_robot_share = get_package_share_directory('turn_on_avalue_robot')
    usb_cam_share = get_package_share_directory('usb_cam')

    return LaunchDescription([
        # 初始化小车底盘
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([os.path.join(turn_on_avalue_robot_share, 'launch', 'turn_on_avalue_robot.launch.py')])
        ),
