...
#include "play_path.h"
#include "avalue_mic_msg/msg/motion_control.hpp"
#include "avalue_robot_msg/msg/position.hpp"
using namespace std;
...
private:
	...
	rclcpp::Subscription<avalue_mic_msg::msg::MotionControl>::SharedPtr motion_msg_sub;
	rclcpp::Subscription<avalue_robot_msg::msg::Position>::SharedPtr current_position_sub;
	...
	void motion_msg_Callback(const avalue_mic_msg::msg::MotionControl::SharedPtr msg);
	void current_position_Callback(const avalue_robot_msg::msg::Position::SharedPtr msg);
