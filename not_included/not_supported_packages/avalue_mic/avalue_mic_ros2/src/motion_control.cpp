...
功能: 雷达障碍物方位获取 
*********************************************************/
void Motion::current_position_Callback(const avalue_robot_msg::msg::Position::SharedPtr msg)
{
...
功能: 获取目标速度
*********************************************************/
void Motion::motion_msg_Callback(const avalue_mic_msg::msg::MotionControl::SharedPtr msg)
{
...
rclcpp::Node(node_name)
{
	...
	/***创建底盘运动话题订阅者***/
	motion_msg_sub = this->create_subscription<avalue_mic_msg::msg::MotionControl>(
	...
	/***创建障碍物方位话题订阅者***/
	current_position_sub = this->create_subscription<avalue_robot_msg::msg::Position>(
