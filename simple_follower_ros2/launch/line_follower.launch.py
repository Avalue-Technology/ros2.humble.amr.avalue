...
def generate_launch_description():
    ...
    avalue_camera = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, 'avalue_camera.launch.py')),
            condition=UnlessCondition(bool_usbcam),
    )
    avalue_USBcamera = IncludeLaunchDescription(
    ...
    return LaunchDescription([
        avalue_camera,avalue_USBcamera,avalue_robot,
