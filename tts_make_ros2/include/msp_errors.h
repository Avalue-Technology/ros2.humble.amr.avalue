...
enum
{
	...
	MSP_ERROR_STREAM_FILTER					= 10141,	/* 0X279D */   /* AIUI��ǰStream������ */
	MSP_ERROR_STREAM_CLEAR				    = 10142,    /* 0X279E */   /* AIUI��ǰStream������ */
	...
	MSP_ERROR_AUTH_LOCAL_IVW_FORBIDDEN      = 11209,    /* 0x2BC9 */   /* ��ֹʹ�ñ��ػ������� */
	MSP_ERROR_AUTH_APPID_NOT_MATCH			= 11210,	/* 0x2BCA */   /* ��Դappid��Ӧ��appid��ƥ�� */
	MSP_ERROR_AUTH_UID_NOT_MATCH			= 11211,	/* 0x2BCB */   /* ��Դuid�͵�¼�û�uid��ƥ�� */
	MSP_ERROR_AUTH_TRIAL_EXPIRED			= 11212,	/* 0x2BCC */   /* ������Դ���� */
	MSP_ERROR_AUTH_LOCAL_IFD_FORBIDDEN      = 11213,    /* 0x2BC9 */   /* ��ֹʹ�ñ����������� */

	MSP_ERROR_AIUI_NO_ENOUGH_LICENSE		= 11216,	/* 0x2BD0 */   /* AIUI��Ȩ���� */
	...
	SPEECH_ERROR_IVW_BUFFERED_AUDIOD_LITTLE   = 25002,  /* ���Ѽ�ʶ�𻺴���Ƶ���� */
	SPEECH_ERROR_IVW_INVALID_RESTYPE          = 25003,  /* ���Ϸ�����Դ���� */
	SPEECH_ERROR_IVW_INVALID_RESHEADVER       = 25004,  /* ���Ϸ�����Դͷ���汾�� */
