...
from avalue_dual_rtk_driver.um982_serial import UM982Serial
from geometry_msgs.msg import Vector3Stamped


class avalue_dual_rtk_driver(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('port', '/dev/avalue_gnss')
...
rclpy.init()
dual_rtk_driver = avalue_dual_rtk_driver()
