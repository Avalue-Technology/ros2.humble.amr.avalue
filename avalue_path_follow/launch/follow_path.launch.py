...
def generate_launch_description():
    #路径跟踪文件路径
    pathfilename = DeclareLaunchArgument('pathfilename',default_value='/home/avalue/avalue_ros2/src/avalue_path_follow/path/avalue_path')
    #是否循环进行路径跟踪
    run_in_loop = DeclareLaunchArgument('run_in_loop',default_value='True')

    follow_path = launch_ros.actions.Node(
            package='avalue_path_follow', 
